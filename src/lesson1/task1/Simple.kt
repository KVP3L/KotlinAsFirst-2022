 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = hoursArrive * 60 - minutesDepart - hoursDepart * 60 + minutesArrive
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (1 + percent / 100.00).pow(3) * initial
